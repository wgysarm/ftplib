...
QT_MOC_LITERAL(1, 10, 9), // "OnStarted"
QT_MOC_LITERAL(2, 20, 0), // ""
QT_MOC_LITERAL(3, 21, 9) // "OnStopped"

    },
    "FTPServer\0OnStarted\0\0OnStopped"
};
...
void FTPServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (FTPServer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FTPServer::OnStarted)) {
                *result = 0;
            }
        }
        {
            typedef void (FTPServer::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&FTPServer::OnStopped)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject FTPServer::staticMetaObject = {
    { &QTcpServer::staticMetaObject, qt_meta_stringdata_FTPServer.data,
...
// SIGNAL 0
void FTPServer::OnStarted()
{
    QMetaObject::activate(this, &staticMetaObject, 0, Q_NULLPTR);
}

// SIGNAL 1
void FTPServer::OnStopped()
{
